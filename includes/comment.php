...
class Comment extends DatabaseObject {
	...
	public static function make($photo_id, $author="Anonymus", $body) {
		if(!empty($photo_id) && !empty($author) && !empty($body)) {
			$comment = new Comment();
			$comment->photograph_id = intval($photo_id);
	...
	public function try_to_send_notification() {
		...
		$mail->From = "jarmohabakuk@hot.ee";
		$mail->AddAddress("jarmohabakuk@hot.ee", "Photo Gallery Admin");
