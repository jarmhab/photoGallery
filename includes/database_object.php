...
class DatabaseObject{
	...
	private function has_attribute($attribute){
		//get_objects_vars return an associative array with all attributes (including private ones) as the keys and their current values as the value
	...
	//lisaks - katsetan late static bindingut
